...
describe('Section 1: Functional tests', () => {
    ...
    it('Checking inputValidData function with 1 missing mandatory field', () => {

        // Add at least 1 test for checking some mandatory field's absence

        inputValidData()

        cy.get('input#username').scrollIntoView().clear()
        cy.get('h2').contains('First name').click()
        cy.get('.submit_button').should('be.disabled')
...
describe('Section 2: Visual tests', () => {
    ...
    it('My test for second picture', () => {
        cy.log('Will check second logo sizes')
        //checking parameter size
        // height 88, width 116
        cy.get('[data-cy="cypress_logo"]').invoke('height').should('be.lessThan', 90).and('be.greaterThan', 50)
        cy.get('[data-cy="cypress_logo"]').invoke('width').should('be.lessThan', 120).and('be.greaterThan', 100)
    ...
    it('Check that chekbox list is correct', () => {
        // Array of founded 3 elements
        ...
        // Alternative commands for labels
        cy.contains('I have a bike')
        cy.contains('I have a car')
        cy.contains('I have a boat')
    ...
    it('Animal dropdown is correct', () => {
        ...
        // Asserting 6 options of animal
        cy.get('#animal').find('option').should('have.length', 6)
        cy.get('#animal').children().should('have.length', 6)

        // Checking element dropdown text
